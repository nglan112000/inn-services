  ...
  const onFetchInn = useCallback(
    (props = {}) => {
      ...
      handleFetchInn({
        ...
        airConditioner: filter.airConditioner,
        roomPetsAllowed: filter.roomPetsAllowed,
        roomWifi: filter.roomWifi,
        roomRefrigerator: filter.roomRefrigerator,
        roomWashingMachine: filter.roomWashingMachine,
